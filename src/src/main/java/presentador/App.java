...
//numDOC es el numero de documento del paciente y dream es el sueño que se va a registrar
...
//aqui se escribe el reporte estandar, el cual se guarda en el dream repository del paciente
//recibe el numero de documento del paciente, el tipo de enfoque y el id del sueño
    public StandartReport writeStandartReport(String numDoc, String typeApproach, int idDream ) {
        ...
        reportBuilder.writeSymbolicAnalyzer(((SymbolicAnalyzer)enfoqueTerapeutico.getAnalyzerJungiano().get(0)).getAnalysys());
        reportBuilder.writeEmocionalAnalyzer(((EmotionalAnalyzer)enfoqueTerapeutico.getAnalyzerJungiano().get(1)).getAnalysys());
    ...
    public PersonalizedReport writePersonalizedReport(String numDoc, String typeApproach, int idDream) {
        ...
        reportBuilder.writeIdream(idDream);
        reportBuilder.typeReport(((CognitiveAnalyzer)enfoqueTerapeutico.getAnalyzerJungiano().get(0)).getAnalysys());
       return reportBuilder.Build();
    }
//este  metodo me retorna el analisis correspondiente al enfoque terapeutico que se le pase como parametro
    //recibe el numero de documento del paciente, el tipo de enfoque y el id del sueño
    //tipo de enfoque puede ser jungiano o conductual y el cual tendra diferentes analisi
